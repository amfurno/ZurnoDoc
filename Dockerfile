...
# docker build -t zurno_doc .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name zurno_doc zurno_doc
...
# Install JS dependencies (needed for yarn build:css during assets:precompile)
